...
return [
    ...
    |
    */
    "file_size_check_kb" => "فیلد :attribute نباید بیشتر از :maxsize کیلوبایت باشد.",
    "file_size_check_mb" => "فیلد :attribute نباید بیشتر از :maxsize مگابایت باشد.",
    ...
    'jdate_after' => ':attribute باید تاریخی بعد از :date باشد.',
    'jdate_after_equal' => ':attribute باید تاریخی بعد یا برابر با :date باشد.',
    'jdatetime_after' => ':attribute باید زمانی بعد از :date باشد.',
    'jdatetime_after_equal' => ':attribute باید زمانی بعد یا برابر با :date باشد.',
    'jdate_before' => ':attribute باید تاریخی قبل از :date باشد.',
    'jdate_before_equal' => ':attribute باید تاریخی قبل یا برابر با :date باشد.',
    'jdatetime_before' => ':attribute باید زمانی قبل از :date باشد.',
    'jdatetime_before_equal' => ':attribute باید زمانی قبل یا برابر با :date باشد.',
    ...
    'enum' => 'مقدار انتخاب شده برای فیلد :attribute معتبر نمی باشد.',
    ...
    'required_with' => 'تکمیل فیلد :attribute زمانی الزامی است که فیلد :values پر شده باشد.',
    ...
    */
    ...
    'attributes' => [
        ...
        'sort' => 'مرتب سازی',
        'national_code' => 'کدملی',
        'educational_group_id' => 'گروه تحصیلی',
        'code' => 'کد',
    ],
];
