        ...
        public function registerMenuGroup(): void
    {
        ...
        Doravel::menu(function () {
            return [
                MenuGroup::make()
                    ->name('admin.courses')
                    ->title(__('course::field.management_training_courses'))
                    ->icon('fa-regular fa-gear')
                    ->subMenu([
                        MenuSubgroup::make()
                            ->name('admin.courses.management')
                            ->title(__('course::field.courses_list')),
//                        MenuSubgroup::make()
//                            ->name('admin.course-management.course-add')
//                            ->title(__('course::field.courses_add')),
                    ]),
            ];
        });
    }
